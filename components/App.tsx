      ...
      <div className="hud-container absolute inset-0 pointer-events-none z-20 flex flex-col justify-between p-4">
          ...
          <div className="flex justify-between items-start">
              ...
              <div className="flex flex-col items-end gap-2 pointer-events-auto">
                  <button onClick={() => setSettingsModalOpen(true)} aria-label="System Options" className="p-2 rounded-full glass-panel hover:bg-white/10 transition-colors">
          ...
          <div className="flex justify-between items-end">
              ...
              <div className="flex gap-2 pointer-events-auto">
                  {gameState.inventory.map(item => (
                    ...
                    >
                        <div className={`w-8 h-8 icon-${item.icon} bg-cover opacity-80`} aria-hidden="true"></div>
                    </button>
                  ))}
              </div>
              ...
              <div className="flex items-center gap-4 pointer-events-auto">
                  <div className="flex flex-col gap-2">
                      <button onClick={() => zoom(1.2)} aria-label="Zoom In" className="w-10 h-10 rounded-full glass-panel flex items-center justify-center text-cyan-300 hover:text-white transition-colors text-xl"><span aria-hidden="true">+</span></button>
                      <button onClick={() => zoom(1/1.2)} aria-label="Zoom Out" className="w-10 h-10 rounded-full glass-panel flex items-center justify-center text-cyan-300 hover:text-white transition-colors text-xl"><span aria-hidden="true">-</span></button>
                  </div>
