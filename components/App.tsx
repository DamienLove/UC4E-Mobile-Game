      ...
      <div className="hud-container absolute inset-0 pointer-events-none z-20 flex flex-col justify-between p-4">
          ...
          <div className="flex justify-between items-start">
              ...
              <div className="flex flex-col items-end gap-2 pointer-events-auto">
                  <button onClick={() => setSettingsModalOpen(true)} className="p-2 rounded-full glass-panel hover:bg-white/10 transition-colors" aria-label="System Options" title="System Options">
                      <svg className="w-6 h-6 text-gray-300" aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h16" /></svg>
                  </button>
          ...
          <div className="flex justify-between items-end">
              ...
              <div className="flex items-center gap-4 pointer-events-auto">
                  <div className="flex flex-col gap-2">
                      <button onClick={() => zoom(1.2)} className="w-10 h-10 rounded-full glass-panel flex items-center justify-center text-cyan-300 hover:text-white transition-colors text-xl" aria-label="Zoom In" title="Zoom In">+</button>
                      <button onClick={() => zoom(1/1.2)} className="w-10 h-10 rounded-full glass-panel flex items-center justify-center text-cyan-300 hover:text-white transition-colors text-xl" aria-label="Zoom Out" title="Zoom Out">-</button>
                  </div>
                  ...
                  <button 
                    ...
                    aria-label="Open Evolution Matrix"
                    title="Open Evolution Matrix"
                  >
                    <svg className="w-10 h-10 text-white" aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" /></svg>
                  </button>
              </div>
          </div>
      </div>
