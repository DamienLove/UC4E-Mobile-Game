      ...
      <div className="glass-panel w-full max-w-lg p-8">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
              ...
              >
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-3m-1 4l-3 3m0 0l-3-3m3 3V4" /></svg>
                SAVE SIMULATION
              </button>
          </div>
          ...
          <div>
            <label htmlFor="visual-accessibility" className="block text-gray-400 text-sm uppercase tracking-wider mb-2">Visual Accessibility</label>
            <select
