          ...
          <div className="flex justify-between items-end">
              ...
              <div className="flex items-center gap-4 pointer-events-auto">
                  <div className="flex flex-col gap-2">
                      <button
                        onClick={() => zoom(1.2)}
                        className="w-10 h-10 rounded-full glass-panel flex items-center justify-center text-cyan-300 hover:text-white transition-colors text-xl"
                        aria-label="Zoom In"
                        title="Zoom In"
                      >+</button>
                      <button
                  ...
                  <button 
                    ...
                    aria-label="Open Evolution Menu"
                    title="Open Evolution Menu"
                  >
