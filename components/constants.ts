...
export const TUTORIAL_STEPS: TutorialStep[] = [
    { text: "Welcome. Your journey begins. <strong class='text-cyan-400'>Click your consciousness</strong> to prepare for movement.", highlight: '[data-node-id="player_consciousness"]' },
