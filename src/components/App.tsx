        ...
        <div className="fixed bottom-0 left-0 right-0 z-40 pointer-events-none flex flex-col justify-end">
            ...
            <div className="w-full flex justify-end px-4 pb-2 pointer-events-none">
                <div className="pointer-events-auto flex flex-col gap-2">
                    <button onClick={() => zoom(1.2)} aria-label="Zoom in" title="Zoom in" className="w-10 h-10 rounded-full glass-panel flex items-center justify-center text-cyan-300 hover:text-white transition-colors text-xl shadow-lg bg-black/60 border-cyan-800">+</button>
                    <button onClick={() => zoom(1/1.2)} aria-label="Zoom out" title="Zoom out" className="w-10 h-10 rounded-full glass-panel flex items-center justify-center text-cyan-300 hover:text-white transition-colors text-xl shadow-lg bg-black/60 border-cyan-800">-</button>
                </div>
            </div>
            ...
            <div className="bg-slate-950/90 backdrop-blur-md border-t border-cyan-900/50 p-3 pb-safe pointer-events-auto shadow-[0_-10px_40px_rgba(0,0,0,0.8)]">
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-12 gap-2 md:gap-4 items-end">
                    ...
                    <div className="col-span-4 md:col-span-3 flex justify-end items-end gap-2">
                        ...
                        <button onClick={() => setSettingsModalOpen(true)} aria-label="Settings" title="Settings" className="w-12 h-12 rounded-lg bg-slate-800 hover:bg-slate-700 border border-slate-600 flex items-center justify-center text-gray-300 transition-colors">
                            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h16" /></svg>
                        </button>
                        
                        <button 
                            onClick={() => setUpgradeModalOpen(true)}
                            aria-label="Open Matrix Upgrades"
                            title="Open Matrix Upgrades"
